...
ALTER TABLE "users" ADD COLUMN "timezone" varchar(100) DEFAULT 'UTC' NOT NULL;--> statement-breakpoint
...
CREATE INDEX "reminder_events_user_id_idx" ON "reminder_events" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "reminder_events_user_date_type_idx" ON "reminder_events" USING btree ("user_id","local_date","type");